    ...
    <>
        ...
        {open && (
          <div className="fixed inset-0 z-50 h-screen overflow-auto">
            ...
            <motion.div
              ...
              className="relative z-[60] mx-4 my-10 h-fit max-w-5xl rounded-3xl bg-white p-4 font-sans dark:bg-neutral-900 md:mx-auto md:p-10"
            >
              <button
                type="button"
      ...
      >
        ...
        <BlurImage
          ...
          alt={card.title}
          fill
          className="absolute inset-0 z-10 overflow-hidden object-cover"
        />
      </motion.button>
    </>
  )
