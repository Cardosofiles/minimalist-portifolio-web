    ...
    <div className="relative flex h-full items-center justify-center overflow-hidden p-8">
      <div className="flex flex-shrink-0 flex-row items-center justify-center gap-2">
        <Container className="circle-1 h-8 w-8">
          <JavaScriptLogo className="max-sm:w-4 sm:h-4 md:h-4 md:w-4 lg:h-4 lg:w-4" />
        </Container>
        <Container className="circle-2 h-12 w-12">
          <TypeScriptLogo className="md:h-7 md:w-7 lg:h-5 lg:w-5" />
        </Container>
        <Container className="circle-3">
          <Reactlogo className="md:h-10 md:w-10 lg:h-8 lg:w-8" />
        </Container>
        <Container className="circle-4 h-12 w-12">
          <NextJsLogo className="h-6 w-6 md:h-8 md:w-8" />
        </Container>
        <Container className="circle-5 h-8 w-8">
          <TailwindCssLogo className="md:h-6 md:w-6 lg:h-4 lg:w-4" />
        </Container>
      </div>
...
export const Card = ({
  ...
  return (
    <div
      className={cn(
        'bordergroup mx-auto w-full max-w-sm rounded-xl border border-white/[0.1] p-8 group-hover/pin:border-white/[0.2] md:max-w-full',
        className
      )}
      style={{
...
const Container = ({
  ...
  return (
    <div
      className={cn(
        // biome-ignore lint/style/noUnusedTemplateLiteral: <explanation>
        `flex h-16 w-16 items-center justify-center rounded-full md:h-24 md:w-24 lg:h-10 lg:w-10`,
        className
      )}
      style={{
        background: 'rgb(2,0,36)',
...
export const JavaScriptLogo = ({ className }: { className?: string }) => {
  return (
    ...
    >
      ...
      <path
        d="M421.36 492.9c8.523 13.944 19.478 24.093 38.955 24.093 16.365 0 26.763-8.174 26.763-19.478 0-13.549-10.803-18.36-29.015-26.337l-9.948-4.272c-28.738-12.27-47.813-27.663-47.813-60.288 0-29.96 22.815-52.78 58.508-52.78 25.4 0 43.593 8.89 56.591 31.946l-30.975 19.967c-6.81-12.27-14.137-17.094-25.617-17.094-11.674 0-19.074 7.4-19.074 17.094 0 12.024 7.4 16.835 24.462 24.093l9.948 4.273c33.856 14.423 52.935 29.547 52.935 62.904 0 35.993-28.285 55.378-66.306 55.378-37.185 0-61.174-17.663-72.68-40.735zm-138.249 3.14c6.81 12.27 13.066 22.546 28.74 22.546 14.66 0 23.926-5.73 23.926-28.1V317.8h45.998v173.02c0 47.558-27.663 69.184-68.023 69.184-36.506 0-57.447-18.36-68.024-40.725z"
        fill="#000"
      />
    </svg>
  )
      ...
      <defs>
        <clipPath id="clip0_3307_1736">
          <rect
            ...
            height="24.5474"
            fill="white"
            transform="translate(0.273438 0.273682)"
          />
        </clipPath>
      </defs>
    </svg>
