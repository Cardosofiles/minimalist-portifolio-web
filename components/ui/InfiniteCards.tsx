  ...
  return (
    ...
    >
      ...
      >
        {items.map((item, idx) => (
          <li
            className="relative w-[90vw] max-w-full flex-shrink-0 rounded-2xl border border-slate-800 p-5 md:w-[60vw] md:p-16"
            style={{
            ...
            <blockquote>
              ...
              <div className="relative z-20 mt-6 flex flex-row items-center">
                ...
                <span className="flex flex-col gap-1">
                  ...
                  <span className="text-sm font-normal leading-[1.6] text-white">
                    {item.title}
                  </span>
                </span>
              </div>
